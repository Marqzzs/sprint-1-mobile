...
import { ButtonSecundaryTitle } from "../Button/Style";
import {
  ContentConfirmModal,
  SmallGroupModal,
  SmallTextModal,
...
export const ConfirmModal = ({ visible, setShowModalConfirm, ...rest }) => {
    ...
    <Modal visible={visible} transparent={true} animationType="fade">
      <PatientModal>
        <ContentConfirmModal>
          ...
          <ModalText>Consult the data selected for your query</ModalText>
          <SmallGroupModal>
